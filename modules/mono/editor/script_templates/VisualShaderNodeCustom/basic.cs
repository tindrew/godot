...
public partial class VisualShaderNode_CLASS_ : _BASE_
{
    ...
    public override string _GetCode(Redot.Collections.Array<string> inputVars, Redot.Collections.Array<string> outputVars, Shader.Mode mode, VisualShader.Type type)
    {
        return "";
    }
}
