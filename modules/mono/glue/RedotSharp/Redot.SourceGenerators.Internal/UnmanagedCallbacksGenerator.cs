        ...
        foreach (var callback in data.Methods)
        {
            ...
            for (int i = 0; i < callback.Parameters.Length; i++)
            {
                ...
                if (parameter.RefKind == RefKind.Out)
                {
                    ...
                    if (IsRedotInteropStruct(parameter.Type))
...
");
        ...
        foreach (var callback in data.Methods)
        {
            ...
            foreach (var parameter in callback.Parameters)
            {
                if (IsByRefParameter(parameter))
                {
                    if (IsRedotInteropStruct(parameter.Type) || parameter.Type.IsValueType)
                    {
    ...
    private static bool IsRedotInteropStruct(ITypeSymbol type) =>
        _redotInteropStructs.Contains(type.FullQualifiedNameOmitGlobal());
    ...
    private static readonly string[] _redotInteropStructs =
    {
        "Redot.NativeInterop.redot_ref",
        "Redot.NativeInterop.redot_variant_call_error",
        "Redot.NativeInterop.redot_variant",
        "Redot.NativeInterop.redot_string",
        "Redot.NativeInterop.redot_string_name",
        "Redot.NativeInterop.redot_node_path",
        "Redot.NativeInterop.redot_signal",
        "Redot.NativeInterop.redot_callable",
        "Redot.NativeInterop.redot_array",
        "Redot.NativeInterop.redot_dictionary",
        "Redot.NativeInterop.redot_packed_byte_array",
        "Redot.NativeInterop.redot_packed_int32_array",
        "Redot.NativeInterop.redot_packed_int64_array",
        "Redot.NativeInterop.redot_packed_float32_array",
        "Redot.NativeInterop.redot_packed_float64_array",
        "Redot.NativeInterop.redot_packed_string_array",
        "Redot.NativeInterop.redot_packed_vector2_array",
        "Redot.NativeInterop.redot_packed_vector3_array",
        "Redot.NativeInterop.redot_packed_vector4_array",
        "Redot.NativeInterop.redot_packed_color_array",
    };
}
