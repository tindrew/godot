...
const InternalConfig = function (initConfig) { // eslint-disable-line no-unused-vars
	const cfg = /** @lends {InternalConfig.prototype} */ {
		 ...
		 * @param {string} path The path that Redot's wants executed.
		 ...
		 * @param {number} status_code The status code returned by Redot on exit.
		 */
		/**
		 * @ignore
	 ...
	 */
	Config.prototype.getRedotConfig = function (cleanup) {
